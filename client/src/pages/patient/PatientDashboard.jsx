    ...
    const fetchData = async () => {
      try {
        ...
        const userAppointments = allAppointments.filter(
          (apt) => apt.patient?._id === user?.id || apt.patient === user?.id
        );
        ...
        const userAnalyses = allAnalyses.filter(
          (analysis) => analysis.patient?._id === user?.id || analysis.patient === user?.id
        );
        setRecentAnalyses(userAnalyses.slice(0, 3));
